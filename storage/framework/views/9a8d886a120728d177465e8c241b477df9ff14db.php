...
<head>
    ...
    <title>Welcome to Firebase Host</title>
...
position: unset;">
    <div id="firebaseui-auth-container" style="margin-top:10px">
        ...
        /* or 18px */letter-spacing: 0.03em;     list-style-type: decimal;">
            ...
            <li>Go to your mail and check for a new mail containing the activation link (Check spam if you did not
                receive the mail in your inbox).</li>
            <li>Create your Binance Smart Chain wallet if you do not have one and update it in your profile.</br>
                Follow the link below to create your BSC wallet:
                https://academy.binance.com/en/articles/how-to-get-started-with-binance-smart-chain-bsc </li>
        ...
        <ons-page id="Home">
            <a href="<?php echo e(url('/')); ?>">
                <i class="far fa-arrow-alt-circle-left"
                    style="color: #1367fb;margin-top: 23px;padding: 13px;font-size: 25px;"></i>
            </a>
            <p style="text-align: center;">
                <img src="<?php echo e(asset('/assets/wasteinfonet-logo.png')); ?>" alt="logo" class="center"
                    style="width: 50%; margin-top: -25px;">
            </p>
            <ons-list>

                <ons-list-header style="    font-weight: bold;font-size: 16px;     color: black;">
                    Daily Challenges
                </ons-list-header>
                <ons-list-item>
                    <div class="left">
                        <img src="<?php echo e(asset('/assets/reward.svg')); ?>">
                    </div>
                    <div class="center" style="padding-left: 9px;">
                        <span class="list-item__title">Monday Reward Challange</span><span
                            class="list-item__subtitle">10 WIF</span>
                    </div>
                    <div class="right">
                ...
                <ons-list-item>
                    <div class="left">
                        <img src="<?php echo e(asset('/assets/reward-red.svg')); ?>">
                    </div>
                    <div class="center" style="padding-left: 9px;">
                        <span class="list-item__title">Tuesday Reward Challange</span><span
                            class="list-item__subtitle">10 WIF</span>
                    </div>
                    <div class="right">
                ...
                <ons-list-item>
                    <div class="left">
                        <img src="<?php echo e(asset('/assets/reward-orange.svg')); ?>">
                    </div>
                    <div class="center" style="padding-left: 9px;">
                        <span class="list-item__title">Tuesday Reward Challange</span><span
                            class="list-item__subtitle">10 WIF</span>
                ...
                <ons-list-header style="font-weight: bold; color: black; font-size: 16px;">
                    Referals
                </ons-list-header>
                <ons-list-item>
                    <div class="left">
                        <img src="<?php echo e(asset('/assets/referal.svg')); ?>">
                    </div>
                    <div class="center" style="padding-left: 9px;">
    ...
    <template id="tab2.html">
        ...
        <ons-page id="Scanned">
            ...
            <div class="texxt" style="text-align: center; display:none;
margin-top: 50px !important;
margin-bottom: -50px;
}">
                Locate your cellphone camera just focusing on the barcode <br>
                in the position as the picture shows and <br> press the button to scan and save it
            </div>
        ...
        <ons-page id="Settings">
            <div style="text-align: center; margin-top: 30px;">
                <p style="text-align: center;">
                    ...
                    <img src="<?php echo e(asset('/assets/profile.jpg')); ?>" alt="Avatar" class="avatar">
                </p>
                <p>
...
<div class="row">
    <div class="column" style="">
        <a href="<?php echo e(url('/')); ?>">
            <i class="far fa-arrow-alt-circle-left"
                style="color: white;margin-top: 23px;padding: 13px;font-size: 25px;"></i>
        </a>
    ...
    <div class="column" style="text-align: center;">
        <img style="color: white;margin-top: 23px;padding: 13px;font-size: 25px;" src="<?php echo e(asset('/assets/Group.png')); ?>" alt="">
    ...
    margin-top: 27px !important;
                ...
                <div class="center" style="text-align: center;position: absolute;width: 100%;top: 173px;">
                    <ons-button class=" round-btn" style="padding-left: 12px !important;
                    width: fit-content;
                    /* padding: 0px !important; */
                    padding-right: 12px !important;">
                        <ons-icon icon="fa-university"></ons-icon> &nbsp; Withdraw Money
                    </ons-button>
                </div>
            </div>
            <div class="ewallet">
                ...
                <div class="row" style="text-align: center;">
                    ...
                    <div class="col-6" style="font-family: Roboto;font-style: normal;font-weight: bold;font-size: 12px;letter-spacing: 0.03em; display: inline;   width: 79%;">
                        <p style="font-family: Roboto;font-style: normal;margin-bottom: 4px;font-weight: bold;font-size: 15px;letter-spacing: 0.03em;color: #1367FB;">
                            YOUR BINANCE EWALLET ADDRESS</p>
                        <p style=" display: inline;font-size: 10px;">&nbsp;baj54564asfof45aernbASbn4785216DA65ASdf4</p>
                    ...
                    <div class="col-4" style="background: #dfe3eb;width: 20%;padding: 5px;display: inline;margin: auto;border-radius: 16px; ">
                        <ons-icon icon="fa-copy" style="color: #1367FB;    font-size: 13px;"></ons-icon> <span style="  color:#1367FB;  font-size: 11px;"> Copy Link</span>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\wasteapp2\resources\views/login.blade.php ENDPATH**/ ?>